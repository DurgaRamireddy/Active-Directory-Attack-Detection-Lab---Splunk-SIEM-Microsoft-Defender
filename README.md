...
├── README.md
├── scripts/
│   ├── audit-policy-setup.ps1         # Enable advanced audit logging on DC
│   ├── spn-registration.ps1           # Register SPNs on service accounts
│   ├── splunk-inputs.conf             # Forwarder inputs configuration
│   ├── splunk-outputs.conf            # Forwarder outputs configuration
│   └── detection-queries.spl         # All SPL queries from this lab
├── report/
│   └── incident-report.md            # Full formal incident report
└── screenshots/
    ├── splunk-dashboard.png           # SOC detection dashboard
    ├── kerberoasting-4769.png         # Event ID 4769 in Splunk
    ├── asrep-4768.png                 # Event ID 4768 in Splunk
    ├── passthehash-4624.png           # Event ID 4624 in Splunk
    └── dcsync-4662.png               # Event ID 4662 in Splunk
```
